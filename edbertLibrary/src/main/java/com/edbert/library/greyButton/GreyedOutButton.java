package com.edbert.library.greyButton;
 ...
 * @author shiki
 */
public class GreyedOutButton extends Button {

  public GreyedOutButton(Context context) {
    super(context);
  }

  public GreyedOutButton(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public GreyedOutButton(Context context, AttributeSet attrs, int defStyle) {
