...
public class NeedsCommentsDatabaseHelper implements DatabaseHelperInterface {
	...
	public static final String COLUMN_NEEDS_ID = "needs_id";
	...
	public static final String[] COLUMNS = { COLUMN_ID, COLUMN_NEEDS_ID,
	...
	public static final String TABLE_CREATE_ROUTES = "CREATE TABLE "
			...
			+ " TEXT NOT NULL, " + COLUMN_NEEDS_ID + " TEXT NOT NULL, "
