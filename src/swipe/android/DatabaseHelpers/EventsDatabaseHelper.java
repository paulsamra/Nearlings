...
public class EventsDatabaseHelper implements DatabaseHelperInterface {
	...
	public static final String[] COLUMNS = { COLUMN_ID,
			...
			COLUMN_DATE_OF_EVENT, COLUMN_RSVP_COUNT,
			COLUMN_TIME_OF_EVENT, COLUMN_EVENT_NAME,COLUMN_FEE,COLUMN_VISIBILITY,COLUMN_DESCRIPTION,COLUMN_CATEGORY  };
	...
	public static final String TABLE_CREATE_ROUTES = "CREATE TABLE "
			...
			COLUMN_RSVP_COUNT + " INTEGER, "+
			COLUMN_DATE_OF_EVENT + " TEXT NOT NULL, "
