...
public class DiscoverListOfNeedsAdapter extends CursorAdapter {
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		...
		holder.progressBar = (ProgressBar) view.findViewById(R.id.icon_progress);
		view.setTag(holder);
		return view;
	}
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		holder.dateSent.setText(cursor.getString(time_index));
	...
	public static class ViewHolder {
		public TextView dateSent, sender, task, location, price, status;
