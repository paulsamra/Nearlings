...
public class AmountPicker extends Dialog implements OnClickListener {
    Button btn_ok;
    Button btn_cancel;
    TextView txt_input;
    ...
    public interface OnMyNumberSetListener {
         ...
         *            可用以标识调用者
         */
        void onNumberSet(String number, int mode, String address);
    }

    private OnMyNumberSetListener mListener;

    public AmountPicker(Context context, OnMyNumberSetListener listener,
...
address = (EditText) findViewById(R.id.paypal_address);
    ...
    public void onClick(View v) {
        ...
        case R.id.ok:
            ...
            mListener.onNumberSet(number, mode, address_text);
            dismiss();
            break;
        case R.id.cancel:
            dismiss();
