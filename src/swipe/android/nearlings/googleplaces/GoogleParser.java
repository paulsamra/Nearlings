...
public class GoogleParser {
	...
	private static GoogleParser instance;
	AsyncTaskCompleteListener listener;
	String s;

	public GoogleParser(String s) {
		this.s = s;
	}

	public static GoogleParser getInstance(String s, AsyncTaskCompleteListener listener) {

		if (instance == null) {
			instance = new GoogleParser(s);
		}
